  ...
  return (
    <Reveal delay={index * 0.05} duration={0.3}>
      <Link href={`/ventures/${venture.slug}`}>
        <div
          className="group relative rounded-lg border p-3 transition-[translate,border-color] duration-200 hover:-translate-y-px hover:border-chalk-green! motion-reduce:hover:translate-y-0 cursor-pointer bg-card"
