...
export const ventures: Venture[] = [
  ...
  },
  {
    ...
    track: 'internal',
    archetype: 'content',
    // Verified 2026-09-13: HTTPS fails and HTTP serves the same domain-parking lander as aiopsguide.com.
    status: 'Offline · domain parked, content not served',
    icp: 'Founders and operators evaluating AI-native business models.',
    monetization: 'Content-led acquisition hypothesis, not currently pursued.',
    signal: 'The content property is not being served, so there is no current demand signal to read.',
  },
  {
    slug: 'ogpreviewtool',
    ...
    track: 'internal',
    archetype: 'tool',
    // Verified 2026-09-13: the domain returns no DNS answer, so neither HTTP nor HTTPS connects.
    status: 'Offline · domain does not resolve',
    icp: 'Marketers and developers validating social-share cards.',
    monetization: 'Free utility into a paid design or optimization workflow, not currently pursued.',
    signal: 'The tool is not reachable, so there is no current usage signal to read.',
  },
  {
    slug: 'cimreader',
    name: 'CIM Reader',
    ...
    track: 'internal',
    archetype: 'tool',
    // Verified 2026-09-13: HTTPS returns 200 but serves the same domain-parking lander as aiopsguide.com.
    status: 'Offline · domain parked, prototype not served',
    icp: 'PE analysts, family offices, and independent sponsors reviewing CIMs.',
    monetization: 'Per-report fee or subscription hypothesis, not currently tested.',
    signal: 'The prototype is not being served, so there is no current buyer signal to read.',
  },
]
